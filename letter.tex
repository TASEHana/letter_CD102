...
\begin{figure} 
 ...
 and at cryogenic temperatures. A switch is connected to the 
 cavity during data taking, the bypass for the blackbody radiation 
 source is used for the calibration of the amplification chain. 
...
If the physical temperatures $T_\text{c}$ and $T_\text{mx}$ 
...
%0.07~K, 0.12~K, and \noise~K, respectively.  
%Therefore, 
The \ta\ obtained from the calibration is about \noise~K and  
