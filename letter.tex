...
and was connected via holders to the mixing flange. %at a 
...
%time was determined based on the target \bgagg\ limits and the experimental 
%parameters; 
...
the average noise power. %If the axion signal exists, there will be 
%a significant excess above the average noise. 
...
% After the merging, if there were any potential signal with an oSNR larger than 
%3.355, a rescan would be proceeded to check if it were a real signal 
%or a statistical fluctuation. 
%A rescan was performed after 
...
%In total, 22 candidates with an oSNR greater than 3.355 were found. 
...
%  \includegraphics[width=8.6cm]{figures/combineTASEH_all.png}
