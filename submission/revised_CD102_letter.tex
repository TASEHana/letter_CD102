...
$\vec{\bm{B}}$~\cite{[{}][{.The vacuum permittivity $\epsilon_0$ is equal to 
unity in Heaviside-Lorentz units.}]AxionReview}:
\begin{equation}
  C = \frac{\left[\int\left( \vec{\bm{B}}\cdot\vec{\bm{E}}\right) d^3\bm{x}\right]^2}{B_0^2V\int\epsilon_0 E^2 d^3\bm{x}}.
\label{eq:formfactor} 
\end{equation} 
...
\bibitem [{\citenamefont {Sikivie}(1983)}]{SikivieI}%
  \BibitemOpen
\bibfield  {number} {  }\bibfield  {author} {\bibinfo {author} {\bibfnamefont
  {P.}~\bibnamefont {Sikivie}},\ }\href
  {https://doi.org/10.1103/PhysRevLett.51.1415} {\bibfield  {journal} {\bibinfo
   {journal} {Phys. Rev. Lett.}\ }\textbf {\bibinfo {volume} {51}},\ \bibinfo
  {pages} {1415} (\bibinfo {year} {1983})}\BibitemShut {NoStop}%
