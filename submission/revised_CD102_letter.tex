...
is largely unexplored by haloscope experiments and only has a small 
...
respectively. The form factor $C$ for the TM$_{010}$ mode varies from 0.62 to 
0.63 over the operational frequency range. The intrinsic quality factor $Q_0$ 
...
$1.0–1.6$~dB, contributed from the cables, switch, and circulator, between the 
