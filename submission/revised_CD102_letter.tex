...
is largely unexplored by the haloscope experiments and only has a small 
...
\begin{figure*} 
  \centering
  \includegraphics[width=12.9cm]{Figure3.png}
...
better than the limits obtained by the helioscope experiments.  
It is also the first time that a haloscope-type experiment places 
...
\bibitem [{\citenamefont {Bartram}\ \emph
  ...
  Collaboration}),\ }\href {https://arxiv.org/abs/2110.10262} {\  (\bibinfo
